    ...
    <div className="space-y-5 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6  bg-gray-100 p-4 rounded-xl">
        ...
        <StatCard
          ...
          trend={`In ${projects?.length} teams`}
        />
      </div>
      ...
      <div className="grid grid-cols-12 gap-10">
        ...
        <div className="col-span-12 lg:col-span-4 space-y-6   ">
          ...
          <div className="bg-gray-50 rounded-3xl border border-slate-100 p-6 shadow-sm min-h-[400px]">
            <div className="space-y-4">
              ...
              <button className="w-full py-3 mt-4 border-2 border-dashed border-slate-200 rounded-xl text-slate-400 text-sm font-bold hover:border-indigo-300 hover:text-indigo-500 transition-all">
                + Add New Task
              </button>
            </div>
          </div>
